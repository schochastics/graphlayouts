...
#' @param circular not used
#' @export
layout_igraph_centrality <- function(
  g,
  cent,
  scale = TRUE,
  iter = 500,
...
#' @param circular not used
#' @export
layout_igraph_sparse_stress <- function(
  g,
  pivots,
  weights = NA,
  iter = 500,
...
#' @param circular not used
#' @export
layout_igraph_constrained_stress <- function(
  g,
  coord,
  fixdim = "x",
  weights = NA,
  ...
  xy <- layout_with_constrained_stress(
    g,
    coord,
    fixdim,
    weights,
...
#' @param circular not used
#' @export
layout_igraph_multilevel <- function(
  g,
  type = "all",
  FUN1,
  FUN2,
...
#' @param circular not used
#' @export
layout_igraph_focus_group <- function(
  g,
  v,
  group,
  shrink = 10,
...
#' @param circular not used
#' @export
layout_igraph_centrality_group <- function(
  g,
  cent,
  group,
  shrink = 10,
...
#' @param circular not used
#' @export
layout_igraph_fixed_coords <- function(
  g,
  coords,
  weights = NA,
  iter = 500,
