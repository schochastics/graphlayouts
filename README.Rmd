...
See my dedicated [blog post](http://blog.schochastics.net/post/stress-based-graph-layouts/) for more information.

## Example: Connected Network  

*This example is a bit of a special case and exploits some weird issues in igraph. Working on 
adding something more representative* 
```{r example}
library(igraph)   
library(ggraph)   
...
Stress majorization now also works for networks with several components (but not very well yet). It relies 
