...
(When I started this package, my intention was to only implement stress majorization for graph layouts. However, over time, I added some more algorithms so that the former name does not really make sense anymore. Also, this change hopefully gives me an incentive to further extend the package.)
