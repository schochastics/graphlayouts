...
![](reference/figures/README-example_un-1.png)
...
![](reference/figures/README-example_un-2.png)
...
![](reference/figures/README-hairball-1.png)
...
![](reference/figures/README-flex_focus-1.png)
...
![](reference/figures/README-flex_cent-1.png)
...
performs stress majorization only with a small number of pivots
(~50-100). The runtime performance is inferior to pivotMDS but the
...
![](reference/figures/rt-net.png) A retweet network with 18k nodes and
61k edges

![](reference/figures/squad_network2022_small.png) A network of football
players with 165K nodes and 6M edges.

## dynamic layouts

[`layout_as_dynamic()`](https://schochastics.github.io/graphlayouts/reference/layout_dynamic.md)
allows you to visualize snapshots of longitudinal network data. Nodes
are anchored with a reference layout and only moved slightly in each
wave depending on deleted/added edges. In this way, it is easy to track
down specific nodes throughout time. Use `patchwork` to put the
...
![](reference/figures/dynamic_ex.png)
...
can be used to manipulate an existing layout

![](reference/figures/layout_manipulation.png)
