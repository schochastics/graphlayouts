...
This outlines how to propose a change to graphlayouts. For more detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("schochastics/graphlayouts", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://schochastics.github.io/graphlayouts/CODE_OF_CONDUCT.md).
